...
export class DocumentaryReviewBasicDto extends DtoBase {
  @Expose()
  ...
  @Expose()
  @ApiProperty({ example: dayjs().format('YYYY-MM-DD'), description: 'Fecha de la segunda revisión' })
...
export class DocumentaryReviewDto extends DocumentaryReviewBasicDto {}
